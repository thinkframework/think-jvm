...
/**
 * @see com.sun.tools.classfile.CharacterRangeTable_attribute
 * @author lixiaobin
 * @since 2017/3/24
 */
public class CharacterRangeTable_attribute extends Attribute {

    public CharacterRangeTable_attribute(ClassFileReader classFileReader, int attribute_name_index, int attribute_length) throws IOException {
