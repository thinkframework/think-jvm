...
/**
 * @see com.sun.tools.classfile.SourceID_attribute
 * @author lixiaobin
 * @since 2017/3/24
 */
public class SourceID_attribute extends Attribute {

    public SourceID_attribute(ClassFileReader classFileReader, int attribute_name_index, int attribute_length) throws IOException {
