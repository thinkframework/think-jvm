...
/**
 * @see com.sun.tools.classfile.EnclosingMethod_attribute
 * @author lixiaobin
 * @since 2017/3/24
 */
public class EnclosingMethod_attribute extends Attribute {

    public EnclosingMethod_attribute(ClassFileReader classFileReader, int attribute_name_index, int attribute_length) throws IOException {
