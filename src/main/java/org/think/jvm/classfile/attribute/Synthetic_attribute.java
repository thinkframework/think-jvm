...
/**
 * @see com.sun.tools.classfile.Synthetic_attribute
 * @author lixiaobin
 * @since 2017/3/24
 */
public class Synthetic_attribute extends Attribute {

    public Synthetic_attribute(ClassFileReader classFileReader, int attribute_name_index, int attribute_length) throws IOException {
